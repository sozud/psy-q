...
#else
#define VAB_ADDR	0x80015000L		/* vab data address */
#endif
...
extern short SsVabTransBodyPartly (unsigned char* addr, unsigned long bufsize, short vabid);
...
#endif /* VB */
#else  /* PARTLY */
    vab = SsVabOpen((u_char *)VAB_ADDR, (void *)0); /* open vab data */
#endif /* PARTLY */
