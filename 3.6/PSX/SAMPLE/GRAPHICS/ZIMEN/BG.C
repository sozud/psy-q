...
POLY_FT4 *divPolyFT4(u_long *ot, POLY_FT4 *pk, Gs3DBG0 *bp, CTYPE *ctype,
		     CVECTOR rgb1, SVECTOR v0, int ndiv);

POLY_FT4 *divPolyFT4_DPQ(u_long *ot, POLY_FT4 *pk, Gs3DBG0 *bp, CTYPE *ctype,
...
{
	/* 分割後のプリミティブの大きさ: primitive size after division */
	int dx = bp->cw>>ndiv;
	int dy = bp->ch>>ndiv;		  
