...
** LISTCRD
**
** Program to list the contents of a memory card - both on screen and to MESS output
** program attemts to determine if titles are SHIFT-JIS or ASCII character set.
**
** 29-feb-96 (pholman)
**	First version.   Known bugs - too many contents and the screen will not display contents.
*/
#include <r3000.h>
#include <asm.h>
#include <kernel.h>
